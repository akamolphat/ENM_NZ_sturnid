...
dir.create(paste("results/starling/BIOMOD/", range, "/tune_MaxEnt", sep = ""), recursive = T, showWarnings = F)
...
# Define output paths -----------------------------------------------#####
pdfresponseplots <- paste("results/starling/BIOMOD/", range, "/tune_MaxEnt/", range, "_tune_biomod2_maxent", inputversion, ".pdf", sep = "")
outcsv <- paste("results/starling/BIOMOD/", range, "/tune_MaxEnt/", range, "_tune_biomod2_maxent", inputversion, ".csv", sep = "")
...
shpfilepath <- paste("data/starling/", rangeshp, "_calibration_area/starling_", rangeshp, "_calibration_area.shp", sep = "")
...
sf_use_s2(F)  # This is required for nativeNZ data and should not effect native or NZ data on its own
