# 01_nativeNZ_starling_create_dataset_block.R -----------------------
...
# Read in rasters ---------------------------------------------------
varpath <- c(paste("data/starling/comb_calibration_area/", ls_varnames, "_cropped_masked.tif", sep = ""))
...
sf_cal <- st_read(dsn = path.expand("data/starling/comb_calibration_area/starling_comb_calibration_area.shp"))
# Read occurrences --------------------------------------------------
# occfilepath1 <- paste("data/starling/filtered_occurrences/NZ_thinned/32km/starling_NZ_thinned_merged.csv", sep = "")
# occfilepath2 <- paste("data/starling/filtered_occurrences/native_thinned/32km/starling_native_thinned_merged.csv", sep = "")
# 
...
#                             showPlots = F)
# 
# pdf("results/starling/BIOMOD/nativeNZ/sac_sp_all.pdf")
# sac_sp$plots$barchart
# sac_sp2$plots$barchart
# dev.off()
# save(sac_sp, sac_sp2, file = "data/starling/BIOMOD/nativeNZ/sac_sp.Rdata")
# 
