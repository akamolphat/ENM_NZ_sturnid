# NZ_starling_create_dataset_block.R --------------------------------
#
...
pdf("results/starling/BIOMOD/NZ/sac_sp_all.pdf")
sac_sp$plots$barchart
sac_sp2$plots$barchart
dev.off()
save(sac_sp, sac_sp2, file = "data/starling/BIOMOD/NZ/sac_sp.Rdata")
# load(file = "data/starling/BIOMOD/NZ/sac_sp.Rdata")
